...
export default function QuizCurrentLooksScreen() {
  const router = useRouter();
  const { updateUserData } = useOnboarding();

  const handleSelect = (currentLooks: string) => {
    updateUserData({ currentLooks });
    router.push('/onboarding/quiz-5-reason');
  };
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.content}>
          <Text style={styles.question}>How would you describe your current looks?</Text>
