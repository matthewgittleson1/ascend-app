...
export default function QuizFamiliarityScreen() {
  const router = useRouter();
  const { updateUserData } = useOnboarding();

  const handleSelect = (familiarity: string) => {
    updateUserData({ familiarity });
    router.push('/onboarding/quiz-4-current-looks');
  };
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.content}>
          <Text style={styles.question}>How familiar are you with the looksmaxxing community?</Text>
