...
export default function QuizReasonScreen() {
  const router = useRouter();
  const { updateUserData } = useOnboarding();

  const handleSelect = (reason: string) => {
    updateUserData({ reason });
    router.push('/onboarding/quiz-6-last-happy');
  };
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.content}>
          <Text style={styles.question}>What is the biggest reason you want to ascend?</Text>
