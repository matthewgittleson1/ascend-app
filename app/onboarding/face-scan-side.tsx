...
export default function FaceScanSideScreen() {
  const router = useRouter();
  const { capturedImages, setSideImage } = useOnboarding();
  const [isLoading, setIsLoading] = useState(false);

  const hasPhoto = !!capturedImages.sideImage;
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>
            Turn 90 degrees to show your jawline and side profile.
          </Text>
          ...
          <View style={styles.frameContainer}>
            {isLoading ? (
              ...
              <View style={styles.photoContainer}>
                <Image 
                  source={{ uri: capturedImages.sideImage! }} 
                  style={styles.photo}
                  resizeMode="cover"
                />
              ...
              <View style={styles.frame}>
                ...
                <View style={styles.sideProfileIcon}>
                  <Ionicons name="person-outline" size={100} color="rgba(255,255,255,0.2)" />
                </View>
                <Text style={styles.frameHint}>Show your side profile clearly</Text>
              </View>
            )}
          </View>
            ...
            {!hasPhoto ? (
              ...
              <>
                ...
                <TouchableOpacity style={styles.primaryButton} onPress={handleContinue}>
                  ...
                  <Ionicons name="sparkles" size={24} color={AscendColors.bg} />
                </TouchableOpacity>
              </>
            )}
          </View>
